...
# installed.
TCL_PREFIX='/d/CM.git/tcltk86/release'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/d/CM.git/tcltk86/release'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tcl/win -ltcl86'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib -ltcl86'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/d/CM.git/tcltk86/release/include'
...
# compiled.
TCL_SRC_DIR='/d/CM.git/tcltk86/rcompile/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/d/CM.git/tcltk86/release/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tcl/win -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/d/CM.git/tcltk86/rcompile/tcl/win/libtclstub86.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/d/CM.git/tcltk86/release/lib/libtclstub86.a'
