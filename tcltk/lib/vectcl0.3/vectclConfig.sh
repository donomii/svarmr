...
# build directory.
vectcl_BUILD_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/vectcl -lvectcl03'
VECTCL_BUILD_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/vectcl -lvectcl03'

# String to pass to linker to pick up the VecTcl library from its
# installed directory.
vectcl_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/vectcl0.3 -lvectcl03'
VECTCL_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/vectcl0.3 -lvectcl03'
...
# build directory.
vectcl_BUILD_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/vectcl -lvectclstub03'
VECTCL_BUILD_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/vectcl -lvectclstub03'

# String to pass to linker to pick up the VecTcl stub library from its
# installed directory.
vectcl_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/vectcl0.3 -lvectclstub03'
VECTCL_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/vectcl0.3 -lvectclstub03'

# String to pass to linker to pick up the VecTcl stub library from its
# build directory.
vectcl_BUILD_STUB_LIB_PATH='/d/CM.git/tcltk86/rcompile/vectcl/libvectclstub03.a'
VECTCL_BUILD_STUB_LIB_PATH='/d/CM.git/tcltk86/rcompile/vectcl/libvectclstub03.a'

# String to pass to linker to pick up the VecTcl stub library from its
# installed directory.
vectcl_STUB_LIB_PATH='/d/CM.git/tcltk86/release/lib/vectcl0.3/libvectclstub03.a'
VECTCL_STUB_LIB_PATH='/d/CM.git/tcltk86/release/lib/vectcl0.3/libvectclstub03.a'
