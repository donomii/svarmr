...
# build directory.
zlibtcl_BUILD_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tkimg/zlib -lzlibtcl1211'

# String to pass to linker to pick up the zlibtcl library from its
# installed directory.
zlibtcl_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/Img1.4.6 -lzlibtcl1211'
...
# build directory.
zlibtcl_BUILD_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tkimg/zlib -lzlibtclstub1211'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/Img1.4.6 -lzlibtclstub1211'

# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_PATH='/d/CM.git/tcltk86/rcompile/tkimg/zlib/libzlibtclstub1211.a'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_PATH='/d/CM.git/tcltk86/release/lib/Img1.4.6/libzlibtclstub1211.a'
