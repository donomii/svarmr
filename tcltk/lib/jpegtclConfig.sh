...
# build directory.
jpegtcl_BUILD_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tkimg/libjpeg -ljpegtcl92'

# String to pass to linker to pick up the jpegtcl library from its
# installed directory.
jpegtcl_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/Img1.4.6 -ljpegtcl92'

# The name of the jpegtcl stub library (a .a file):
jpegtcl_STUB_LIB_FILE=libjpegtclstub92.a

# String to pass to linker to pick up the jpegtcl stub library from its
# build directory.
jpegtcl_BUILD_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tkimg/libjpeg -ljpegtclstub92'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib/Img1.4.6 -ljpegtclstub92'

# String to pass to linker to pick up the jpegtcl stub library from its
# build directory.
jpegtcl_BUILD_STUB_LIB_PATH='/d/CM.git/tcltk86/rcompile/tkimg/libjpeg/libjpegtclstub92.a'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_PATH='/d/CM.git/tcltk86/release/lib/Img1.4.6/libjpegtclstub92.a'
