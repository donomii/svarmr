...
# installed.
TK_PREFIX='/d/CM.git/tcltk86/release'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/d/CM.git/tcltk86/release'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tk/win -ltk86'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/d/CM.git/tcltk86/rcompile/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/rcompile/tk/win -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/d/CM.git/tcltk86/release/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/d/CM.git/tcltk86/rcompile/tk/win/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/d/CM.git/tcltk86/release/lib/libtkstub86.a'
